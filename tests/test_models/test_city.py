...
class TestCity(unittest.TestCase):
    ...
    def setUp(cls):
        """City testing by :
            ...
            Reseting FileStorage objects dic.
            Creating FileStorage, DBStorage, City and State instances.
        """
        try:
    ...
    def tear_down(cls):
        """City testing by :
            ...
            Deleting the FileStorage, DBStorage, City and State test instances.
        """
        try:
            os.remove("file.json")
        except IOError:
