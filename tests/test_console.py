...
class TestHBNBCommand(unittest.TestCase):
    ...
    def set_up(cls):
        """HBNBCommand testing reset_obj by :
            ...
            Creating an instance of the command interpreter.
        """
        try:
    ...
    @classmethod
    def tear_down(cls):
        """HBNBCommand testing delete_fjson by :
            Restoring original file.json.
            Deleting the test Command instance.
        """
        try:
    ...
    def test_create_kwargs(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            call = ('create Place city_id="0001" name="My_place" '
                    'number_rooms=3 latitude=20.65 longitude=a')
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            self.assertIn("'name': 'My place'", output)
            self.assertIn("'number_rooms': 3", output)
            self.assertIn("'latitude': 20.65", output)
